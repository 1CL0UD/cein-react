      ...
      <div className="" id="homeBody">
          ...
          <div className="row m-auto py-4">
            ...
            <div className="row col-md-6 my-auto">
              <div className="product-highlight-content">
                ...
                <p>
                  Discover products tailored for mature skin and urban
                  lifestyles, offering daily hydration and the added advantage
        ...
        <section className="container-fluid hero hero-2nd">
          <div className="hero-content">
            ...
            <p className="fs-6">
              ...
              and in no way inferior to facial care. It’s time to give our body
        ...
        <section className="container-fluid">
          <Quotes
            ...
            smallSubText={false}
          >
            Countless answers lie within nature's genius, awaiting our
